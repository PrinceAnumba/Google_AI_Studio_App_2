  ...
  return (
    <div className="">
      <div className="my-0 mx-auto bg-[#e9e4e4] dark:bg-[#100020] flex items-center p-2 rounded w-full max-w-[500px]">
        <Input
          type="text"
          className="bg-transparent border-none focus:ring-0 focus:outline-none focus-visible:ring-0 rounded-none text-gray-500"
          placeholder="Input your text here"
          value={userInput}
          onChange={(e) => setUserInput(e.target.value)}
        />
        <Button onClick={handleSubmit}>
          {!loading ? <Icons.arrowUp className="w-6" /> : <div></div>}
